...
enum I2C_MEM {
	...
	I2C_MEM_CARD_TYPE = I2C_MODBUS_SETINGS_ADD + 5,

	I2C_MEM_PPS,
	I2C_MEM_IN_FREQENCY = I2C_MEM_PPS + OPTO_CH_NO * OPTO_FREQUENCY_DATA_SIZE ,
	I2C_MEM_PWM_IN_FILL = I2C_MEM_IN_FREQENCY + OPTO_CH_NO * OPTO_FREQUENCY_DATA_SIZE,
	I2C_END  = I2C_MEM_PWM_IN_FILL + OPTO_CH_NO * OPTO_FREQUENCY_DATA_SIZE,
