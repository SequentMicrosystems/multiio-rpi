...
const CliCmdType CMD_UOUT_READ = {/*{{{*/
	...
	"  Usage:           multiio <id> uoutrd <channel>\n",
	"  Example:         multiio 0 uoutrd 2 #Read voltage on 0-10V out channel #2 on board #0\n",
};
...
const CliCmdType CMD_IOUT_READ = {/*{{{*/
	...
	"  Usage:           multiio <id> ioutrd <channel>\n",
	"  Example:         multiio 0 ioutrd 2 #Read voltage on 4-20mA out channel #2 on board #0\n",
};
